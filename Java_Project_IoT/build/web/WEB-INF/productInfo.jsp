<%-- 
    ...
    Created on : May 3, 2024, 8:18:11 PM
    Author     : dalyk
--%>
    ...
    <body>
        ...
        <div class="container-fluid d-flex justify-content-start">
            <div class="d-inline-flex">
                <img src="<%=request.getContextPath() + "/Images/"+request.getAttribute("productName") +".jpg"%>" width='500' height='500'">
            </div>
            <div class="d-flex justify-content-center col-5">
                <div class="mx-3" style="max-width: 50vw;">
                    ...
                    <p class="align-self-center">Quantity  <%= request.getAttribute("productQte") %></p>
                    <hr class="my-4">
                    ...
                    <div class="row flex-column justify-content-center">
                        ...
                        <form action="<%= request.getContextPath() %>/mainPage/addToCart" method="get">
                            <c:if test="${1==1}">
                            ...
                            <div class="d-flex justify-content-center">
                                ...
                                <input class="" style="text-align:center" type="text" id="quantity" name="QteOrder" value="1"/>
                                <button type="button" onclick="increaseQuantity()" >+</button>
                            </div>
                            <input class="btn" type="submit" style="background-color: rgb(8, 172, 10); color: white;" value="Ajouter au panier"/>
                        </form>
                    </div>
                </div>
            </div>
